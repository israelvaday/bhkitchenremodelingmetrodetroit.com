...
const title = "Contact Us | Metro Detroit Kitchen Remodeling";
const description = `Contact ${BIZ.name} to discuss a kitchen remodeling project, text photos, or request a free quote across Metro Detroit.`;
