...
export function Hero() {
  ...
  const poster = `${base}/photos/branding-generated--hero-kitchen-metro-detroit.png`;
    ...
    <section className="relative isolate overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col leading-tight">
          ...
          <span className="font-mono text-[10px] text-ink-300">Remodel · Cabinets · Counters · Design</span>
        </div>
      </div>
      ...
      <div className="relative mx-auto flex min-h-[92vh] max-w-5xl flex-col items-center justify-center px-4 pb-20 pt-24 text-center md:min-h-[88vh] md:px-6 md:pt-32">
        ...
        >
          Metro Detroit{" "}
          <span className="text-brass-gradient">kitchen remodeling done right</span>.
        </h1>
        ...
        >
          {["Full remodels", "Cabinets", "Countertops", "Design", "Backsplash", "Islands"].map((s) => (
            <li
              key={s}
        ...
        >
          <li className="flex items-center gap-1.5">
            <ChefHat className="h-4 w-4 text-brass-400" />
